...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
    ...
    public MyAdapter(Context context, ArrayList<Vocab> data, VocabPageChangeInterface pageChangeInterface) {
            ...
            textView.setOnClickListener(v -> {
                ...
                if (position != RecyclerView.NO_POSITION) {
                    ...
                    if(context.getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT){
                        ...
                        VocabFragment vocabFragment = new VocabFragment(data.get(position), pageChangeInterface);                        FragmentManager fragmentManager = ((MainActivity) context).getSupportFragmentManager();
